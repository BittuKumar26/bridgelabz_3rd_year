...
package level1;
public class Univesityfeediscount {
    public static void main(String[] args) {
        int fee=125000;
        float disc =(fee*10)/100;
        float disc_price=fee-disc;
        System.out.println("The discount amount is INR " + disc +" and final discounted fee is INR  "+ disc_price);
    }
}
